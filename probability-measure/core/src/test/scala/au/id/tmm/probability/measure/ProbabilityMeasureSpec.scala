...
import au.id.tmm.probability.measure.ProbabilityMeasure.{ConstructionError, Varied}
import au.id.tmm.probabilitymeasure.ProbabilityMeasure.{Always, ConstructionError, Varied}
